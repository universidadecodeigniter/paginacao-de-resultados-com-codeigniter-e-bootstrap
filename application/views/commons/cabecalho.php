...
<html lang="pt_BR">
  <head>
    ...
    <meta name="description" content="Tutorial ensinando a trabalhar com paginação de resultados nativa do CodeIgniter, implementando o layout de paginação do Bootstrap">
    <meta name="author" content="Universidade CodeIgniter">
    <link rel="icon" href="<?=base_url('assets/images/unici/favicon.png')?>">

    <title>Paginação de resultados com CodeIgniter e Bootstrap</title>
